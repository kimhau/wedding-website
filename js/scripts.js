$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event Address
            address: 'Restoran Suang Hee, Mentakab',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Kim Hau at +65 90532343."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbz3M23qxj0BqJq7S1xhsrO4aRBm7dqtiUQ6aHpRwpd15-IgJCyXl07iq6ChAj0MaFhU/exec', data)
                .done(function (data) {
                    console.log(data);
